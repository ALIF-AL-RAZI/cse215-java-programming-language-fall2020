...
public class Telecom {
  ...
  public static void main(String[] args) {
    String[] listA = { "1.Details", "2.Balance", "3. Internet Packages", "4. Social Packages", "5. Emergency Loan", "6. My Offers", "7. FnF Offers", "8. Back", "9. Exit" };
    ...
    ImageIcon icon = new ImageIcon("H:\\cse.project.new\\icon1.jpg");
